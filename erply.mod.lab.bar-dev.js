$(document).ready(function() {
    ...
    if (TSPOS.Model.POS.name == "Lab Club OÜ / Labor VP8-1") {
        ...
        ErplyEPSI.openWebSocket = function() {
            ErplyEPSI.websocket = new Meh(this.getWebSocketHost());

            if(ErplyEPSI.websocket) {
                console.log(`Meh - websocket true`);
            }

            ErplyEPSI.localServerUp=!0;
            ErplyEPSI.websocket.send("request=test");
            let e = {
